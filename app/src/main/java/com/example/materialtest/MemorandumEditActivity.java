...
import com.example.materialtest.util.MyTimeGetter;

import java.text.Format;
import java.util.Date;

import static com.example.materialtest.util.MyFormat.*;


@RequiresApi(api = Build.VERSION_CODES.N)
public class MemorandumEditActivity extends AppCompatActivity implements View.OnClickListener,
        DatePickerDialog.OnDateSetListener,
        TimePickerDialog.OnTimeSetListener{
    private final static String TAG = "MemorandumEditActivity";
    ...
    void init(){
        ...
        createDate = MyFormat.myDateFormat(date, DateFormatType.NORMAL_TIME);
        dispCreateDate = MyFormat.getTimeStr(date);
     ...
     */
    void intentStart(){
        Intent intent = new Intent(MemorandumEditActivity.this,MemorandumActivity.class);
    ...
    void showDialog(final String title, final String body, final String createDate){
        dialog = new AlertDialog.Builder(MemorandumEditActivity.this);
        dialog.setTitle("提示");
     ...
     */
    void showAskDialog(){
        AlertDialog.Builder dialog = new AlertDialog.Builder(MemorandumEditActivity.this);
        dialog.setTitle("提示");
        DatePicker datePicker = dialogDate.getDatePicker();
    ...
    public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
        ...
        String noticeStr = "  提醒时间："+MyFormat.getTimeStr(
                MyFormat.myDateFormat(year,(month+1),dayOfMonth,hour,minute,DateFormatType.NORMAL_TIME));
