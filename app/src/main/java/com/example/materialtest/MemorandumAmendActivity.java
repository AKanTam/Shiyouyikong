 ...
 */
public class MemorandumAmendActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_memorandum_amend);
        init();
     ...
     */
    void intentStart(){
        Intent intent = new Intent(MemorandumAmendActivity.this,MemorandumActivity.class);
    ...
    void showDialog(final String body){
        dialog = new AlertDialog.Builder(MemorandumAmendActivity.this);
        dialog.setTitle("提示");
